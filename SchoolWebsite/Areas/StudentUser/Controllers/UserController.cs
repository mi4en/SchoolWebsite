...
namespace SchoolWebsite.Areas.StudentUser.Controllers
{
    public class UserController : Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        // GET: StudentUser/User
        public async Task<ActionResult> Index()
        {
            return View(await db.Students.ToListAsync());
        }

        // GET: StudentUser/User/Details/5
        ...
        // GET: StudentUser/User/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: StudentUser/User/Create
        ...
        // POST: StudentUser/User/Delete/5
